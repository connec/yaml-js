  ...
  this.Scanner = (function() {
    ...
    */
    ...
    Scanner.prototype.check_document_start = function() {
      var _ref;
      if (this.column === 0 && this.prefix(3) === '---' && (_ref = this.peek(3), __indexOf.call(C_LB + C_WS + '\x00', _ref) >= 0)) {
        return true;
      }
      return false;
    };
    ...
    */
    ...
    Scanner.prototype.check_block_entry = function() {
      var _ref;
      return _ref = this.peek(1), __indexOf.call(C_LB + C_WS + '\x00', _ref) >= 0;
    };
    ...
    */
    ...
    Scanner.prototype.check_plain = function() {
      var char, _ref;
      char = this.peek();
      return __indexOf.call(C_LB + C_WS + '\x00-?:,[]{}#&*!|>\'"%@`', char) < 0 || ((_ref = this.peek(1), __indexOf.call(C_LB + C_WS + '\x00', _ref) < 0) && (char === '-' || (this.flow_level === 0 && __indexOf.call('?:', char) >= 0)));
    };
    ...
    */
    ...
    Scanner.prototype.scan_to_next_token = function() {
      ...
      while (!found) {
        ...
        if (this.peek() === '#') {
          while (_ref = this.peek(), __indexOf.call(C_LB + '\x00', _ref) < 0) {
            this.forward();
          }
        }
    ...
    */
    ...
    Scanner.prototype.scan_yaml_directive_value = function(start_mark) {
      ...
      throw new exports.ScannerError('while scanning a directive', start_mark, "expected a digit or ' ' but found " + (this.peek()), (_ref = this.peek(), __indexOf.call(C_LB + '\x00 ', _ref) < 0) ? this.get_mark() : void 0);
      return [major, minor];
    };
    ...
    */
    ...
    Scanner.prototype.scan_block_scalar = function(style) {
      ...
      while (this.column === indent && this.peek() !== '\x00') {
        ...
        length = 0;
        while (_ref4 = this.peek(length), __indexOf.call(C_LB + '\x00', _ref4) < 0) {
          length++;
        }
    ...
    */
    ...
    Scanner.prototype.scan_flow_scalar_non_spaces = function(double, start_mark) {
      ...
      while (true) {
        length = 0;
        while (_ref = this.peek(length), __indexOf.call(C_LB + C_WS + '\'"\\\x00', _ref) < 0) {
          length++;
        }
        if (length !== 0) {
          chunks.push(this.prefix(length));
    ...
    */
    ...
    Scanner.prototype.scan_plain = function() {
      ...
      while (true) {
        ...
        while (true) {
          char = this.peek(length);
          if (__indexOf.call(C_LB + C_WS + '\x00', char) >= 0 || (this.flow_level === 0 && char === ':' && (_ref = this.peek(length + 1), __indexOf.call(C_LB + C_WS + '\x00', _ref) >= 0)) || (this.flow_level !== 0 && __indexOf.call(',:?[]{}', char) >= 0)) {
            break;
          }
          length++;
        }
        if (this.flow_level !== 0 && char === ':' && (_ref1 = this.peek(length + 1), __indexOf.call(C_LB + C_WS + '\x00,[]{}', _ref1) < 0)) {
          this.forward(length);
