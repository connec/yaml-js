(function() {
  ...
  this.SerializerError = (function(superClass) {
    class SerializerError extends superClass {};

    SerializerError.__super__ = superClass.prototype;
  ...
  this.Serializer = (function() {
    ...
    class Serializer {
      ...
      initialise(arg) {
        var arg, encoding, explicit_end, explicit_start, ref, tags, version;
        ref = arg != null ? arg : {}, encoding = ref.encoding, explicit_start = ref.explicit_start, explicit_end = ref.explicit_end, version = ref.version, tags = ref.tags;
