(function() {
  ...
  this.ResolverError = (function(superClass) {
    class ResolverError extends superClass {};

    ResolverError.__super__ = superClass.prototype;
    ...
    class BaseResolver {
      ...
      static add_implicit_resolver(tag, regexp, first = [null]) {
        ...
        if (!this.prototype.hasOwnProperty('yaml_implicit_resolvers')) {
          this.prototype.yaml_implicit_resolvers = util.clone(this.prototype.yaml_implicit_resolvers);
        }
        results = [];
  ...
  this.Resolver = (function(superClass) {
    class Resolver extends superClass {};

    Resolver.__super__ = superClass.prototype;
