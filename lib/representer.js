(function() {
  ...
  this.RepresenterError = (function(superClass) {
    class RepresenterError extends superClass {};

    RepresenterError.__super__ = superClass.prototype;
  ...
  this.BaseRepresenter = (function() {
    ...
    class BaseRepresenter {
      ...
      initialise(arg) {
        var arg, default_flow_style, default_style, ref;
        ref = arg != null ? arg : {}, default_style = ref.default_style, default_flow_style = ref.default_flow_style;
  ...
  this.Representer = (function(superClass) {
    class Representer extends superClass {
    ...
    Representer.__super__ = superClass.prototype;
