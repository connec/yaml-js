(function() {
  ...
  this.ConstructorError = (function(superClass) {
    class ConstructorError extends superClass {};

    ConstructorError.__super__ = superClass.prototype;
    ...
    class BaseConstructor {
      ...
      static add_constructor(tag, constructor) {
        if (!this.prototype.hasOwnProperty('yaml_constructors')) {
          this.prototype.yaml_constructors = util.clone(this.prototype.yaml_constructors);
        }
      ...
      static add_multi_constructor(tag_prefix, multi_constructor) {
        if (!this.prototype.hasOwnProperty('yaml_multi_constructors')) {
          this.prototype.yaml_multi_constructors = util.clone(this.prototype.yaml_multi_constructors);
        }
