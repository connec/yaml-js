(function() {
  ...
  module.exports = (function() {
    ...
    exports.ConstructorError = (function() {
    ...
    exports.BaseConstructor = (function() {
      ...
      */
      ...
      BaseConstructor.prototype.construct_document = function(node) {
        ...
        while (!_.isEmpty(this.deferred_constructors)) {
    ...
    exports.Constructor = (function() {
      ...
      __extends(Constructor, exports.BaseConstructor);
      ...
      Constructor.prototype.construct_yaml_object = function(node, klass) {
        ...
        data = new klass;
        this.defer(function() {
          return _.extend(data, _this.construct_mapping(node, true));
        });
        return data;
      };
    ...
    exports.Constructor.add_constructor('tag:yaml.org,2002:null', exports.Constructor.prototype.construct_yaml_null);

    exports.Constructor.add_constructor('tag:yaml.org,2002:bool', exports.Constructor.prototype.construct_yaml_bool);

    exports.Constructor.add_constructor('tag:yaml.org,2002:int', exports.Constructor.prototype.construct_yaml_int);

    exports.Constructor.add_constructor('tag:yaml.org,2002:float', exports.Constructor.prototype.construct_yaml_float);

    exports.Constructor.add_constructor('tag:yaml.org,2002:binary', exports.Constructor.prototype.construct_yaml_binary);

    exports.Constructor.add_constructor('tag:yaml.org,2002:timestamp', exports.Constructor.prototype.construct_yaml_timestamp);

    exports.Constructor.add_constructor('tag:yaml.org,2002:omap', exports.Constructor.prototype.construct_yaml_omap);

    exports.Constructor.add_constructor('tag:yaml.org,2002:pairs', exports.Constructor.prototype.construct_yaml_pairs);

    exports.Constructor.add_constructor('tag:yaml.org,2002:set', exports.Constructor.prototype.construct_yaml_set);

    exports.Constructor.add_constructor('tag:yaml.org,2002:str', exports.Constructor.prototype.construct_yaml_str);

    exports.Constructor.add_constructor('tag:yaml.org,2002:seq', exports.Constructor.prototype.construct_yaml_seq);

    exports.Constructor.add_constructor('tag:yaml.org,2002:map', exports.Constructor.prototype.construct_yaml_map);

    exports.Constructor.add_constructor(null, exports.Constructor.prototype.construct_yaml_undefined);
